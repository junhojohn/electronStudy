...
<Project DefaultTargets="Build" ToolsVersion="14.0" xmlns="http://schemas.microsoft.com/developer/msbuild/2003">
  ...
  <PropertyGroup Label="Globals">
    <ProjectGuid>{1BB7C81B-4A67-CEDF-C5F6-D8F08D900960}</ProjectGuid>
  ...
  <ItemGroup>
    <ClCompile Include="E:\tmp\IRGAdvanced05\node_modules\node-gyp\src\win_delay_load_hook.cc"/>
  </ItemGroup>
  <ItemGroup>
    <CustomBuild Include="$(OutDir)\node_sqlite3.node">
      <FileType>Document</FileType>
      <Command>call mkdir &quot;E:\tmp\IRGAdvanced05\node_modules\sqlite3\lib\binding\electron-v2.0-win32-x64&quot; 2&gt;nul &amp; set ERRORLEVEL=0 &amp; copy /Y &quot;$(OutDir)node_sqlite3.node&quot; &quot;E:\tmp\IRGAdvanced05\node_modules\sqlite3\lib\binding\electron-v2.0-win32-x64\node_sqlite3.node&quot;&#xD;&#xA;if %errorlevel% neq 0 exit /b %errorlevel%</Command>
      <Message>Copying $(OutDir)/node_sqlite3.node to E:/tmp/IRGAdvanced05/node_modules/sqlite3/lib/binding/electron-v2.0-win32-x64\node_sqlite3.node</Message>
      <Outputs>E:\tmp\IRGAdvanced05\node_modules\sqlite3\lib\binding\electron-v2.0-win32-x64\node_sqlite3.node</Outputs>
    </CustomBuild>
  </ItemGroup>
  <ItemGroup>
    <ProjectReference Include="node_sqlite3.vcxproj">
      <Project>{BA3ED9A3-08BB-5D6F-5B20-1D88B478B67E}</Project>
